...
New classes has been added in the Storage component, `XmlAdaptedJob` and `XmlAdaptedRemark`, to support the saving of job entries into the data file (as shown in the diagram below).

.Partial Class Diagram of Storage Component
image::StorageComponent_Xml_Job_Xml_Remark.PNG[width="800"]
[none]
