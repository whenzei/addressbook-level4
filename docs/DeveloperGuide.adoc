...
New classes has also been added in the Storage component, `XmlAdaptedJob` and `XmlAdaptedRemark`, to support the saving of job entries into the data file (as shown in the diagram below).
