...
This section will teach you the basics of working around in the application.

Opening the Carvicim.jar file, you should see the Graphical User Interface (GUI) as shown in the image below.
+
