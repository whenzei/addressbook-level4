...
** Highlights: This enhancement requires the morphing of the _AddressBook - Level 4_ project and requires substantial changes to the codebase. The implementation required changes to existing commands so that the newly added commands would work properly. Most changes were 
