...
** Documentation:
*** Worked on improving the user-friendliness of the User Guide by adding screenshots and restructuring the sections to have a better flow. (Pull request https://github.com/CS2103JAN2018-W09-B1/main/pull/179[#179])
